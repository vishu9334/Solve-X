...
const CharacterSection = () => {
    ...
    const isInView = useInView(priceRef, { once: true, margin: "-100px 0px" });
                    ...
                    <div className="relative w-full max-w-[700px] rounded-[24px] bg-white border border-black/[0.06] p-8 md:p-12 text-center shadow-[0_18px_60px_rgba(62,62,244,0.08)] overflow-hidden">
                        ...
                        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
                            ...
                            >
                                <Link
                                    to="/register"
                                    className="inline-flex items-center justify-center gap-2 rounded-full border border-white/25 bg-gradient-to-b from-[#242424] from-[19%] to-black px-7 py-3 text-sm font-medium tracking-[-0.03em] text-white transition-colors hover:from-[#2e2e2e] hover:to-neutral-900 cursor-pointer"
                                >
                                    Get Started
                            ...
                            >
                                <Link
                                    to="/student-doc"
                                    className="inline-flex items-center justify-center gap-2 rounded-full border border-black/12 bg-white px-7 py-3 text-sm font-medium tracking-[-0.03em] text-black transition-colors hover:bg-neutral-50 cursor-pointer shadow-sm"
                                >
                                    View Details
                                </Link>
                            </motion.div>
