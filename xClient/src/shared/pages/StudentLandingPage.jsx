        ...
        <main className="relative min-h-screen w-full overflow-x-hidden bg-[radial-gradient(circle_at_82%_6%,rgba(255,217,110,0.42),transparent_28%),radial-gradient(circle_at_76%_18%,rgba(62,62,244,0.55),transparent_34%),radial-gradient(circle_at_28%_99%,rgba(9,12,179,0.60),transparent_48%),linear-gradient(180deg,#050509_0%,#060612_58%,#15131a_100%)] px-4 pb-24 pt-8 text-white sm:px-6 lg:px-8">
            ...
            <nav className="relative z-20 mx-auto flex w-full max-w-7xl items-center justify-between rounded-full border border-white/10 bg-black/20 px-5 py-3 backdrop-blur-md">
                ...
                <div className="hidden xl:flex items-center gap-5">
                    ...
                    <Link to="/student/ask-doubt" className="rounded-full border border-white/20 bg-white/10 backdrop-blur-md px-5 py-2 text-xs font-bold text-white transition-all hover:bg-white/20 hover:shadow-[0_0_15px_rgba(255,255,255,0.15)]">
                        Ask a Doubt
                    </Link>
                </div>
                ...
                <button
                    ...
                    className="flex xl:hidden items-center justify-center p-1 bg-transparent border-none text-white focus:outline-none cursor-pointer"
                >
                ...
                {menuOpen && (
                    <div className="absolute top-[110%] left-0 right-0 z-[1000] flex flex-col gap-3 rounded-3xl border border-blue-500/25 bg-blue-950/45 px-6 py-5 shadow-[0_20px_50px_rgba(30,58,138,0.25)] backdrop-blur-xl xl:hidden">
                        <Link
                        ...
                        <Link
                            ...
                            className="mt-2 w-full h-[42px] flex items-center justify-center rounded-full border border-white/20 bg-white/10 backdrop-blur-md text-white text-xs font-bold hover:bg-white/20 transition-all cursor-pointer"
                            onClick={() => setMenuOpen(false)}
                        >
                            Ask a Doubt
                        </Link>
